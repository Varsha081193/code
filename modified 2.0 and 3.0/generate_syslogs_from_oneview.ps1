...
#Alerts to Syslog
GetAlerts -ApplianceIP $ApplianceIP -UserName $UserName -password $Global:appPassword -mode "interactive"

#Tasks to Syslog
#GetTasks -ApplianceIP $ApplianceIP -UserName $UserName -password $Global:appPassword -mode "interactive"

#Audits to syslogs
#GetAuditlogs -ApplianceIP $ApplianceIP -UserName $UserName -password $Global:appPassword -mode "interactive"
